...
let sexp_of_nvrtc_result = function
  ...
  | NVRTC_ERROR_UNCATEGORIZED i64 -> Sexplib0.Sexp.List [Sexplib0.Sexp.Atom "NVRTC_ERROR_UNCATEGORIZED"; Sexplib0.Sexp.Atom (Int64.to_string i64)]
