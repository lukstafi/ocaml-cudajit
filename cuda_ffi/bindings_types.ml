...
let sexp_of_cu_result = function
  ...
  | CUDA_ERROR_UNSUPPORTED_EXEC_AFFINITY ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_UNSUPPORTED_EXEC_AFFINITY"
  ...
  | CUDA_ERROR_SHARED_OBJECT_SYMBOL_NOT_FOUND ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_SHARED_OBJECT_SYMBOL_NOT_FOUND"
  | CUDA_ERROR_SHARED_OBJECT_INIT_FAILED ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_SHARED_OBJECT_INIT_FAILED"
  ...
  | CUDA_ERROR_LAUNCH_INCOMPATIBLE_TEXTURING ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_LAUNCH_INCOMPATIBLE_TEXTURING"
  | CUDA_ERROR_PEER_ACCESS_ALREADY_ENABLED ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_PEER_ACCESS_ALREADY_ENABLED"
  ...
  | CUDA_ERROR_HOST_MEMORY_ALREADY_REGISTERED ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_HOST_MEMORY_ALREADY_REGISTERED"
  | CUDA_ERROR_HOST_MEMORY_NOT_REGISTERED ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_HOST_MEMORY_NOT_REGISTERED"
  ...
  | CUDA_ERROR_COOPERATIVE_LAUNCH_TOO_LARGE ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_COOPERATIVE_LAUNCH_TOO_LARGE"
  ...
  | CUDA_ERROR_COMPAT_NOT_SUPPORTED_ON_DEVICE ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_COMPAT_NOT_SUPPORTED_ON_DEVICE"
  ...
  | CUDA_ERROR_MPS_MAX_CONNECTIONS_REACHED ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_MPS_MAX_CONNECTIONS_REACHED"
  ...
  | CUDA_ERROR_STREAM_CAPTURE_UNSUPPORTED ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_STREAM_CAPTURE_UNSUPPORTED"
  | CUDA_ERROR_STREAM_CAPTURE_INVALIDATED ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_STREAM_CAPTURE_INVALIDATED"
  ...
  | CUDA_ERROR_STREAM_CAPTURE_WRONG_THREAD ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_STREAM_CAPTURE_WRONG_THREAD"
  | CUDA_ERROR_TIMEOUT -> Sexplib0.Sexp.Atom "CUDA_ERROR_TIMEOUT"
  | CUDA_ERROR_GRAPH_EXEC_UPDATE_FAILURE ->
      Sexplib0.Sexp.Atom "CUDA_ERROR_GRAPH_EXEC_UPDATE_FAILURE"
  ...
  | CUDA_ERROR_UNCATEGORIZED i64 ->
      Sexplib0.Sexp.List
        [ Sexplib0.Sexp.Atom "CUDA_ERROR_UNCATEGORIZED"; Sexplib0.Sexp.Atom (Int64.to_string i64) ]

type cu_device = Cu_device of int

let sexp_of_cu_device = function
  | Cu_device i ->
      Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "Cu_device"; Sexplib0.Sexp.Atom (Int.to_string i) ]
...
let sexp_of_cu_jit_option = function
  | CU_JIT_MAX_REGISTERS -> Sexplib0.Sexp.Atom "CU_JIT_MAX_REGISTERS"
  | CU_JIT_THREADS_PER_BLOCK -> Sexplib0.Sexp.Atom "CU_JIT_THREADS_PER_BLOCK"
  | CU_JIT_WALL_TIME -> Sexplib0.Sexp.Atom "CU_JIT_WALL_TIME"
  | CU_JIT_INFO_LOG_BUFFER -> Sexplib0.Sexp.Atom "CU_JIT_INFO_LOG_BUFFER"
  | CU_JIT_INFO_LOG_BUFFER_SIZE_BYTES -> Sexplib0.Sexp.Atom "CU_JIT_INFO_LOG_BUFFER_SIZE_BYTES"
  | CU_JIT_ERROR_LOG_BUFFER -> Sexplib0.Sexp.Atom "CU_JIT_ERROR_LOG_BUFFER"
  | CU_JIT_ERROR_LOG_BUFFER_SIZE_BYTES -> Sexplib0.Sexp.Atom "CU_JIT_ERROR_LOG_BUFFER_SIZE_BYTES"
  | CU_JIT_OPTIMIZATION_LEVEL -> Sexplib0.Sexp.Atom "CU_JIT_OPTIMIZATION_LEVEL"
  | CU_JIT_TARGET_FROM_CUCONTEXT -> Sexplib0.Sexp.Atom "CU_JIT_TARGET_FROM_CUCONTEXT"
  | CU_JIT_TARGET -> Sexplib0.Sexp.Atom "CU_JIT_TARGET"
  | CU_JIT_FALLBACK_STRATEGY -> Sexplib0.Sexp.Atom "CU_JIT_FALLBACK_STRATEGY"
  | CU_JIT_GENERATE_DEBUG_INFO -> Sexplib0.Sexp.Atom "CU_JIT_GENERATE_DEBUG_INFO"
  | CU_JIT_LOG_VERBOSE -> Sexplib0.Sexp.Atom "CU_JIT_LOG_VERBOSE"
  | CU_JIT_GENERATE_LINE_INFO -> Sexplib0.Sexp.Atom "CU_JIT_GENERATE_LINE_INFO"
  | CU_JIT_CACHE_MODE -> Sexplib0.Sexp.Atom "CU_JIT_CACHE_MODE"
  | CU_JIT_NEW_SM3X_OPT -> Sexplib0.Sexp.Atom "CU_JIT_NEW_SM3X_OPT"
  | CU_JIT_FAST_COMPILE -> Sexplib0.Sexp.Atom "CU_JIT_FAST_COMPILE"
  | CU_JIT_GLOBAL_SYMBOL_NAMES -> Sexplib0.Sexp.Atom "CU_JIT_GLOBAL_SYMBOL_NAMES"
  | CU_JIT_GLOBAL_SYMBOL_ADDRESSES -> Sexplib0.Sexp.Atom "CU_JIT_GLOBAL_SYMBOL_ADDRESSES"
  | CU_JIT_GLOBAL_SYMBOL_COUNT -> Sexplib0.Sexp.Atom "CU_JIT_GLOBAL_SYMBOL_COUNT"
  | CU_JIT_LTO -> Sexplib0.Sexp.Atom "CU_JIT_LTO"
  | CU_JIT_FTZ -> Sexplib0.Sexp.Atom "CU_JIT_FTZ"
  | CU_JIT_PREC_DIV -> Sexplib0.Sexp.Atom "CU_JIT_PREC_DIV"
  | CU_JIT_PREC_SQRT -> Sexplib0.Sexp.Atom "CU_JIT_PREC_SQRT"
  | CU_JIT_FMA -> Sexplib0.Sexp.Atom "CU_JIT_FMA"
  | CU_JIT_REFERENCED_KERNEL_NAMES -> Sexplib0.Sexp.Atom "CU_JIT_REFERENCED_KERNEL_NAMES"
  | CU_JIT_REFERENCED_KERNEL_COUNT -> Sexplib0.Sexp.Atom "CU_JIT_REFERENCED_KERNEL_COUNT"
  | CU_JIT_REFERENCED_VARIABLE_NAMES -> Sexplib0.Sexp.Atom "CU_JIT_REFERENCED_VARIABLE_NAMES"
  | CU_JIT_REFERENCED_VARIABLE_COUNT -> Sexplib0.Sexp.Atom "CU_JIT_REFERENCED_VARIABLE_COUNT"
  | CU_JIT_OPTIMIZE_UNUSED_DEVICE_VARIABLES ->
      Sexplib0.Sexp.Atom "CU_JIT_OPTIMIZE_UNUSED_DEVICE_VARIABLES"
  | CU_JIT_POSITION_INDEPENDENT_CODE -> Sexplib0.Sexp.Atom "CU_JIT_POSITION_INDEPENDENT_CODE"
  | CU_JIT_NUM_OPTIONS -> Sexplib0.Sexp.Atom "CU_JIT_NUM_OPTIONS"
  | CU_JIT_UNCATEGORIZED i64 ->
      Sexplib0.Sexp.List
        [ Sexplib0.Sexp.Atom "CU_JIT_UNCATEGORIZED"; Sexplib0.Sexp.Atom (Int64.to_string i64) ]
